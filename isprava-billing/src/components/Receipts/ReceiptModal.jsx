...
const ReceiptModal = ({ isOpen, setIsOpen, receiptInfo }) => {
  function closeModal() {
    setIsOpen(false);
  }
    ...
    toPng(dom)
      .then((dataUrl) => {
        ...
        img.onload = () => {
          ...
          pdf.save(`receipt-${receiptInfo.receiptNumber}.pdf`);
        };
      })
      .catch((error) => {
